...
def main():
    ...
    while (1):
        try:
            ...
            # don't just quit when the user presses ctrl + c,
            # write a zero byte to stop the motors, then end the program.

            # apparently once isn't enough. Try doing it fifty times.
            for _ in range(50): port.write(bytearray([0]))
            break
    """
