...
image of type numpy.uint8.'''
	...
	dist = numpy.loadtxt("Distortion.txt")
        cmat = numpy.loadtxt("CameraMatrix.txt")
        # Object coordinates
        opts = numpy.array([[aprilsize, -aprilsize, 0.],
        ...
        for i in range(0, detections.contents.size):
            ...
            retval, rvec, tvec = cv2.solvePnP(opts,corners,cmat,dist)
	    print tvec
            detection = Detection(
